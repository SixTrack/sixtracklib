...
//     /* Handle command line arguments: */
    ...
    beam_elements_buffer = NS(Buffer_new_from_file)(
    ...
    for( ii = 0 ; ii < NUM_PARTICLES ; ++ii )
    {
        ...
        NS(Particles_set_at_element_id_value)( particles, ii, 0 );
        NS(Particles_set_at_turn_value)( particles, ii, 0 );
    }
    ...
    NS(ClArgument)* beam_elements_arg =
        NS(ClArgument_new_from_buffer)( beam_elements_buffer, ctx );
