...
int main( int argc, char* argv[] )
{
    ...
    st_TrackJobCl*  track_job = SIXTRL_NULLPTR;
    ...
    if( argc < 4 )
    {
        printf( "Usage: %s DEVICE_STR PATH_TO_PARTICLES PATH_TO_BEAM_ELEMENTS\r\n",
                argv[ 0 ] );
        ...
        ( NUM_PARTICLES > 0 ) && ( NUM_TURNS > 0 ) )
    {
        ...
        temp_particles_buffer = st_TrackJobCl_get_particle_buffer(
            track_job );
