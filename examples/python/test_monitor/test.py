...
pysixtracklib.TrackJobCL.print_nodes()

part=pysixtracklib.Particles(num_particles=16).set_reference(p0c=7e12,mass0=938.272046e6,q0=1)

elem=pysixtracklib.Elements()
...
job=pysixtracklib.TrackJobCL(part,elem,"0.0")
job.track(10,0)
