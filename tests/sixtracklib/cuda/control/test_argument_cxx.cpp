...
TEST( CXX_CudaArgumentTests, BasicUsage )
{
    ...
    cuda_arg_t arg4( &config_orig, sizeof( config_orig ), &cuda_controller );
    ...
    ASSERT_TRUE( arg4.ptrRawArgument() == &config_orig );
    ASSERT_TRUE( arg4.size() == sizeof( config_orig ) );
    ASSERT_TRUE( arg4.size() <= arg4.capacity() );
    ...
    status = arg4.send( &config_copy, sizeof( config_copy ) );
