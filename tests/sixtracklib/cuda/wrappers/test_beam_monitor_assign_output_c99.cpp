      ...
      TestDefaultBeamMonitorConfig )
{
    ...
    pindex_t const TURN_BY_TURN_START = min_at_turn_id;
    pindex_t const UNTIL_TURN_TURN_BY_TURN = pindex_t{ 10 } + min_at_turn_id;
    pindex_t const UNTIL_TURN = pindex_t{ 100 } + min_at_turn_id;
    pindex_t const SKIP_TURNS = pindex_t{ 10 };
