...
TEST( CommonGpuKernelToolsTests, FileExistsAndGetFileSize )
{
    ...
    std::string const path_to_file1(
        prefix + "tests/sixtracklib/common/testdata/first_file.txt" );

    std::string const path_to_file2(
        prefix + "tests/sixtracklib/common/testdata/second_file.txt" );

    std::string const path_to_file3(
        prefix + "tests/sixtracklib/common/testdata/single_really_long_line.txt" );

    std::string const path_to_empty_file(
        prefix + "tests/sixtracklib/common/testdata/totally_empty_file.txt" );

    std::string const path_to_existing_directory(
        prefix + "tests/sixtracklib/common/testdata" );

    std::string const path_to_non_existing_file(
        prefix + "tests/sixtracklib/common/testdata/not_existing_file.txt" );
...
TEST( CommonGpuKernelToolsTests, BuildSimpleKernelFileList )
{
    ...
    char INPUT_FILES_STR[] =
        "tests/sixtracklib/common/testdata/first_file.txt,"
        "tests/sixtracklib/common/testdata/second_file.txt,"
        "tests/sixtracklib/common/testdata/first_file.txt,"
        "tests/sixtracklib/common/testdata/totally_empty_file.txt,"
        "tests/sixtracklib/common/testdata/single_really_long_line.txt";
...
/* end: tests/sixtracklib/common/test_gpu_kernel_tools.cpp */
