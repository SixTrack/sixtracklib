...
TEST( CXX_Cpu_CpuTrackJobSetupTests, CreateTrackJobNoOutput )
{
    ...
    ASSERT_TRUE( job0.archId() == st::ARCHITECTURE_CPU );
    ASSERT_TRUE( 0 == job0.archStr().compare( SIXTRL_ARCHITECTURE_CPU_STR ) );
    ...
    ASSERT_TRUE( job1.archId() == st::ARCHITECTURE_CPU );
    ASSERT_TRUE( job1.archStr().compare( SIXTRL_ARCHITECTURE_CPU_STR ) == 0 );
    ...
    ASSERT_TRUE( job2.archId() == st::ARCHITECTURE_CPU );
    ASSERT_TRUE( job2.archStr().compare( SIXTRL_ARCHITECTURE_CPU_STR ) == 0 );
    ...
    ASSERT_TRUE( job3.archId() == st::ARCHITECTURE_CPU );
    ASSERT_TRUE( job3.archStr().compare( SIXTRL_ARCHITECTURE_CPU_STR ) == 0 );
    ...
    track_job_t job4( pb, eb, &my_output_buffer );

    ASSERT_TRUE( job4.archId() == st::ARCHITECTURE_CPU );
    ASSERT_TRUE( job4.archStr().compare( SIXTRL_ARCHITECTURE_CPU_STR ) == 0 );
...
TEST( CXX_Cpu_CpuTrackJobSetupTests, CreateTrackJobElemByElemOutput )
{
    namespace st_test   = SIXTRL_CXX_NAMESPACE::tests;
    namespace st        = SIXTRL_CXX_NAMESPACE;
    ...
    track_job_t job4( pb, eb, &my_output_buffer, NUM_ELEM_BY_ELEM_TURNS );
...
TEST( CXX_Cpu_CpuTrackJobSetupTests, CreateTrackJobBeamMonitor )
{
    namespace st_test   = SIXTRL_CXX_NAMESPACE::tests;
    namespace st        = SIXTRL_CXX_NAMESPACE;
...
TEST( CXX_Cpu_CpuTrackJobSetupTests, CreateTrackJobBeamMonitorAndElemByElem )
{
    namespace st_test   = SIXTRL_CXX_NAMESPACE::tests;
    namespace st        = SIXTRL_CXX_NAMESPACE;
...
/* end: tests/sixtracklib/common/track/test_track_job_setup_cxx.cpp */
