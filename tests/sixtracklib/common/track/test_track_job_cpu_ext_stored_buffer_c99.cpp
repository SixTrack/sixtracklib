...
TEST( C99_Cpu_CpuTrackJobExtStoredBufferTests, MinimalUsage )
{
    ...
    ASSERT_TRUE( !::NS(TrackJob_has_ext_stored_buffers)( job ) );

    ASSERT_TRUE(  ::NS(TrackJob_num_ext_stored_buffers)( job ) ==
                  size_t{ 0 } );

    ASSERT_TRUE(  ::NS(TrackJob_min_ext_stored_buffer_id)( job ) ==
                  ::NS(ARCH_ILLEGAL_BUFFER_ID) );

    ASSERT_TRUE(  ::NS(TrackJob_max_ext_stored_buffer_id)( job ) ==
                  ::NS(ARCH_ILLEGAL_BUFFER_ID) );
    ...
    size_t const ext_buffer_01_id = ::NS(TrackJob_create_ext_stored_buffer)(
        job, ext_buffer_01_capacity );

    ASSERT_TRUE(  ext_buffer_01_id != ::NS(ARCH_ILLEGAL_BUFFER_ID) );

    ASSERT_TRUE(  ::NS(TrackJob_num_ext_stored_buffers)( job ) == size_t{ 1 } );
    ASSERT_TRUE(  ::NS(TrackJob_min_ext_stored_buffer_id)( job ) !=
                  ::NS(ARCH_ILLEGAL_BUFFER_ID) );
    ...
    ASSERT_TRUE(  ext_buffer_01_id ==
                  ::NS(TrackJob_min_ext_stored_buffer_id)( job ) );

    ASSERT_TRUE(  ext_buffer_01_id ==
                  ::NS(TrackJob_max_ext_stored_buffer_id)( job ) );

    ASSERT_TRUE(  ::NS(TrackJob_owns_ext_stored_buffer)(
        job, ext_buffer_01_id ) );

    ASSERT_TRUE(  ::NS(TrackJob_ext_stored_buffer)(
    ...
    ASSERT_TRUE(  ext_buffer_01_capacity == ::NS(Buffer_get_capacity)(
        ::NS(TrackJob_ext_stored_buffer)( job, ext_buffer_01_id ) ) );
    ...
    size_t const ext_buffer_02_id = ::NS(TrackJob_add_ext_stored_buffer)(
        job, ext_buffer_02, false, false ); /* false == take no ownership */

    ASSERT_TRUE(  ext_buffer_02_id != ::NS(ARCH_ILLEGAL_BUFFER_ID) );
    ASSERT_TRUE(  ::NS(TrackJob_num_ext_stored_buffers)( job ) == size_t{ 2 } );
    ...
    ASSERT_TRUE( ::NS(ARCH_STATUS_SUCCESS) ==
        ::NS(TrackJob_remove_ext_stored_buffer)( job, ext_buffer_02_id ) );
    ...
    size_t const ext_buffer_02_id_b = ::NS(TrackJob_add_ext_stored_buffer)(
    ...
    ASSERT_TRUE(  reinterpret_cast< uintptr_t >(
        ::NS(TrackJob_ext_stored_buffer)( job, ext_buffer_02_id_b ) ) !=
    ...
    c_buffer_t* ext_buffer_02_b = ::NS(TrackJob_ext_stored_buffer)(
        job, ext_buffer_02_id_b );
    ...
    ASSERT_TRUE( ::NS(TrackJob_ext_stored_buffer)( job, ext_buffer_02_id_b )
                 == ext_buffer_02_b );
    ...
    size_t const ext_buffer_03_id = ::NS(TrackJob_add_ext_stored_buffer)(
        job, &ext_buffer_03, false, false ); /* false == take no ownership */

    ASSERT_TRUE(  ext_buffer_03_id != ::NS(ARCH_ILLEGAL_BUFFER_ID) );
    ASSERT_TRUE(  ::NS(TrackJob_num_ext_stored_buffers)( job ) == size_t{ 3 } );
    ...
    ASSERT_TRUE(  ::NS(TrackJob_ext_stored_buffer)( job, ext_buffer_03_id ) ==
                  &ext_buffer_03 );
    ...
    size_t const ext_buffer_04_id = ::NS(TrackJob_add_ext_stored_buffer)(
    ...
    ASSERT_TRUE(  ::NS(TrackJob_num_ext_stored_buffers)( job ) == size_t{ 4 } );
    ...
    c_buffer_t* ptr_ext_buffer_04 =
        ::NS(TrackJob_ext_stored_buffer)( job, ext_buffer_04_id );
...
/* end: tests/sixtracklib/common/track/test_track_job_cpu_ext_stored_buffer_c99.cpp */
