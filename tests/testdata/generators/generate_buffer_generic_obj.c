...
int main()
{
    ...
    SIXTRL_ASSERT( ptr_obj1 != SIXTRL_NULLPTR );
    ( void )ptr_obj1;
    ...
    SIXTRL_ASSERT( ptr_obj2 != SIXTRL_NULLPTR );
    ( void )ptr_obj2;
    ...
    SIXTRL_ASSERT( ptr_obj3 != SIXTRL_NULLPTR );
    ( void )ptr_obj3;
    ...
    SIXTRL_ASSERT( ptr_obj4 != SIXTRL_NULLPTR );
    ( void )ptr_obj4;
    ...
    SIXTRL_ASSERT( ptr_obj5 != SIXTRL_NULLPTR );
    ( void )ptr_obj5;
