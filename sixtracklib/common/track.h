...
SIXTRL_HOST_FN int NS(Track_particle_element_by_element_details)(
    ...
    SIXTRL_BUFFER_ARGPTR_DEC const struct NS(Buffer) *const SIXTRL_RESTRICT beam_elements,
    SIXTRL_PARTICLE_ARGPTR_DEC NS(Particles)* SIXTRL_RESTRICT out_particles,
    NS(elem_by_elem_order_t) const order );
...
SIXTRL_HOST_FN SIXTRL_BUFFER_ARGPTR_DEC struct NS(Buffer)* NS(TrackCpu)(
    char const* SIXTRL_RESTRICT device_id_str,
    SIXTRL_PARTICLE_ARGPTR_DEC NS(Particles)* SIXTRL_RESTRICT particles,
    SIXTRL_BUFFER_ARGPTR_DEC struct NS(Buffer)* SIXTRL_RESTRICT beam_elements,
    SIXTRL_BUFFER_ARGPTR_DEC struct NS(Buffer)* SIXTRL_RESTRICT output,
