#ifndef SIXTRACKLIB_COMMON_CONTEXT_ARCH_BASE_OBJECT_HPP__
#define SIXTRACKLIB_COMMON_CONTEXT_ARCH_BASE_OBJECT_HPP__
...
#endif /* SIXTRACKLIB_COMMON_CONTEXT_ARCH_BASE_OBJECT_HPP__ */

/* end: sixtracklib/common/context/arch_base.hpp */
