#ifndef SIXTRACKLIB_COMMON_CONTEXT_ARCH_INFO_HPP__
#define SIXTRACKLIB_COMMON_CONTEXT_ARCH_INFO_HPP__
...
namespace SIXTRL_CXX_NAMESPACE
{
    class ArchInfo
    {
        ...
        using arch_id_t = SIXTRL_CXX_NAMESPACE::context_type_id_t;
...
#endif /* SIXTRACKLIB_COMMON_CONTEXT_ARCH_INFO_HPP__ */

/* end: sixtracklib/common/context/arch_info.hpp */
