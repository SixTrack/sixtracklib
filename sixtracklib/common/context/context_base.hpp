#ifndef SIXTRACKLIB_COMMON_CONTEXT_CONTEXT_BASE_HPP__
#define SIXTRACKLIB_COMMON_CONTEXT_CONTEXT_BASE_HPP__
...
extern "C" { typedef SIXTRL_CXX_NAMESPACE::ContextBase  NS(ContextBase); }
...
/* end: sixtracklib/common/context/context_base.hpp */
