#ifndef SIXTRACKLIB_COMMON_IMPL_BUFFER_DEFINES_H__
#define SIXTRACKLIB_COMMON_IMPL_BUFFER_DEFINES_H__
...
#endif /* SIXTRACKLIB_COMMON_IMPL_BUFFER_DEFINES_H__ */

/* end: sixtracklib/common/impl/buffer_defines.h */
