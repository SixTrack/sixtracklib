...
SIXTRL_FN SIXTRL_STATIC bool NS(Drift_can_be_added)(
    SIXTRL_BE_BUFFER_ARGPTR_DEC const NS(Buffer) *const SIXTRL_RESTRICT buffer,
    SIXTRL_BE_BUFFER_ARGPTR_DEC NS(buffer_size_t)* SIXTRL_RESTRICT ptr_requ_objects,
    SIXTRL_BE_BUFFER_ARGPTR_DEC NS(buffer_size_t)* SIXTRL_RESTRICT ptr_requ_slots,
    SIXTRL_BE_BUFFER_ARGPTR_DEC NS(buffer_size_t)* SIXTRL_RESTRICT ptr_requ_dataptrs );

SIXTRL_FN SIXTRL_STATIC SIXTRL_BE_BUFFER_DATAPTR_DEC NS(Drift)* NS(Drift_new)(
    SIXTRL_BE_BUFFER_ARGPTR_DEC NS(Buffer)* SIXTRL_RESTRICT buffer );

SIXTRL_FN SIXTRL_STATIC SIXTRL_BE_BUFFER_DATAPTR_DEC NS(Drift)* NS(Drift_add)(
    SIXTRL_BE_BUFFER_ARGPTR_DEC NS(Buffer)* SIXTRL_RESTRICT buffer,
    NS(drift_real_t) const length );
...
SIXTRL_FN SIXTRL_STATIC bool NS(DriftExact_can_be_added)(
    SIXTRL_BE_BUFFER_ARGPTR_DEC const NS(Buffer) *const SIXTRL_RESTRICT buffer,
    SIXTRL_BE_BUFFER_ARGPTR_DEC NS(buffer_size_t)* SIXTRL_RESTRICT requ_objects,
    SIXTRL_BE_BUFFER_ARGPTR_DEC NS(buffer_size_t)* SIXTRL_RESTRICT requ_slots,
    SIXTRL_BE_BUFFER_ARGPTR_DEC NS(buffer_size_t)* SIXTRL_RESTRICT requ_dataptrs );

SIXTRL_FN SIXTRL_STATIC SIXTRL_BE_BUFFER_DATAPTR_DEC NS(DriftExact)*
NS(DriftExact_new)( SIXTRL_BE_BUFFER_ARGPTR_DEC
    ...
    SIXTRL_BE_BUFFER_ARGPTR_DEC NS(buffer_size_t)* SIXTRL_RESTRICT requ_dataptrs )
{
    ...
    SIXTRL_BE_BUFFER_ARGPTR_DEC buf_size_t const* sizes   = SIXTRL_NULLPTR;
    SIXTRL_BE_BUFFER_ARGPTR_DEC buf_size_t const* counts  = SIXTRL_NULLPTR;
...
SIXTRL_INLINE SIXTRL_BE_BUFFER_DATAPTR_DEC NS(Drift)* NS(Drift_new)(
    SIXTRL_BE_BUFFER_ARGPTR_DEC NS(Buffer)* SIXTRL_RESTRICT buffer )
{
    typedef NS(Drift)                               elem_t;
    typedef SIXTRL_BE_BUFFER_DATAPTR_DEC elem_t*    ptr_to_elem_t;
    typedef NS(buffer_size_t)                       buf_size_t;

    buf_size_t const num_dataptrs =
        NS(DriftExact_get_num_dataptrs)( SIXTRL_NULLPTR );

    SIXTRL_BE_BUFFER_ARGPTR_DEC buf_size_t const* offsets = SIXTRL_NULLPTR;
    SIXTRL_BE_BUFFER_ARGPTR_DEC buf_size_t const* sizes   = SIXTRL_NULLPTR;
    SIXTRL_BE_BUFFER_ARGPTR_DEC buf_size_t const* counts  = SIXTRL_NULLPTR;
...
SIXTRL_INLINE SIXTRL_BE_BUFFER_DATAPTR_DEC NS(Drift)* NS(Drift_add)(
    SIXTRL_BE_BUFFER_ARGPTR_DEC  NS(Buffer)* SIXTRL_RESTRICT buffer,
    NS(drift_real_t) const length )
{
    typedef NS(Drift)                               elem_t;
...
SIXTRL_INLINE SIXTRL_BE_BUFFER_DATAPTR_DEC NS(DriftExact)*
NS(DriftExact_new)( SIXTRL_BE_BUFFER_ARGPTR_DEC NS(Buffer)*
