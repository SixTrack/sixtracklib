#ifndef SIXTRACKLIB_COMMON_BUFFER_ALIGNMENT_H__
#define SIXTRACKLIB_COMMON_BUFFER_ALIGNMENT_H__
...
#endif /* SIXTRACKLIB_COMMON_BUFFER_ALIGNMENT_H__ */

/* end: sixtracklib/common/buffer/alignment.h */
