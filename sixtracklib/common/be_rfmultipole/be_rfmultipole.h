...
#define SIXTRACKL_COMMON_BE_RFMULTIPOLE_BE_RFMULTIPOLE_C99_H__
    ...
    #include "sixtracklib/common/buffer/object_type_id.h"
...
SIXTRL_STATIC SIXTRL_FN SIXTRL_BE_ARGPTR_DEC NS(rf_multipole_real_t) const*
...
SIXTRL_INLINE SIXTRL_BE_ARGPTR_DEC NS(rf_multipole_real_t) const*
NS(RFMultiPole_const_bal)( SIXTRL_BE_ARGPTR_DEC const NS(RFMultiPole)
    *const SIXTRL_RESTRICT mpole )
{
