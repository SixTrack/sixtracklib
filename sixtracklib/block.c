...
// LinearMap
double LinearMap_get_cx(CLGLOBAL value_t *elem) { return elem[1].f64; }
double LinearMap_get_sx(CLGLOBAL value_t *elem) { return elem[2].f64; }
double LinearMap_get_cpx(CLGLOBAL value_t *elem) { return elem[3].f64; }
double LinearMap_get_spx(CLGLOBAL value_t *elem) { return elem[4].f64; }
double LinearMap_get_cy(CLGLOBAL value_t *elem) { return elem[5].f64; }
double LinearMap_get_sy(CLGLOBAL value_t *elem) { return elem[6].f64; }
double LinearMap_get_cpy(CLGLOBAL value_t *elem) { return elem[7].f64; }
double LinearMap_get_spy(CLGLOBAL value_t *elem) { return elem[8].f64; }
double LinearMap_get_ap(CLGLOBAL value_t *elem) { return elem[9].f64; }
double LinearMap_get_h(CLGLOBAL value_t *elem) { return elem[10].f64; }
double LinearMap_get_fRF(CLGLOBAL value_t *elem) { return elem[11].f64; }
...
void track_single(Particles *particles, uint64_t partid,
  ...
  if (particles->state[partid] >= 0) {
    ...
    case AlignID:
      ...
      break;
    case LinearMapID:
      LinearMap_track(particles, partid, LinearMap_get_cx(elem),
                   LinearMap_get_sx(elem), LinearMap_get_cpx(elem), 
                   LinearMap_get_spx(elem),LinearMap_get_cy(elem), 
                   LinearMap_get_sy(elem), LinearMap_get_cpy(elem),
                   LinearMap_get_spy(elem),LinearMap_get_ap(elem),
                   LinearMap_get_h(elem),LinearMap_get_fRF(elem) );
      break;
