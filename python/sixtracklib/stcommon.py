...
st_TrackJob_stored_buffers_capacity = sixtracklib.st_TrackJob_stored_buffers_capacity
...
st_TrackJob_add_stored_buffer.argtypes = [
    st_TrackJob_p, st_Buffer_p, ct.c_bool, ct.c_bool]
...
if SIXTRACKLIB_MODULES.get('opencl', False):
    ...
    st_ClArgument_attach_to_context.argtypes = [
        st_ClArgument_p, st_ClContextBase_p]
    ...
    st_ClContext_assign_beam_monitor_output.argtypes = [
        st_ClContext_p, st_particle_index_t, st_buffer_size_t]
