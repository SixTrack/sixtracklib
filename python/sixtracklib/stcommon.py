...
st_ARCH_MAX_USER_DEFINED_BUFFER_ID = st_arch_status_t(
    0xFFFFFFFFFFFFFFFE
)
...
st_Buffer_init_from_data.argtypes = [
    st_Buffer_p,
    st_uchar_p,
    ct.c_uint64,
]
...
st_Buffer_get_num_of_objects = (
    sixtracklib.st_Buffer_get_num_of_objects_ext
)
...
st_Buffer_get_data_begin_addr = (
    sixtracklib.st_Buffer_get_data_begin_addr_ext
)
...
st_Buffer_get_data_end_addr = (
    sixtracklib.st_Buffer_get_data_end_addr_ext
)
...
st_Buffer_get_objects_end_addr = (
    sixtracklib.st_Buffer_get_objects_end_addr_ext
)
...
st_Buffer_get_num_of_slots = (
    sixtracklib.st_Buffer_get_num_of_slots_ext
)
...
st_Buffer_get_max_num_of_slots = (
    sixtracklib.st_Buffer_get_max_num_of_slots_ext
)
...
st_Buffer_get_num_of_dataptrs = (
    sixtracklib.st_Buffer_get_num_of_dataptrs_ext
)
...
st_Buffer_reserve_capacity = (
    sixtracklib.st_Buffer_reserve_capacity_ext
)
...
st_AssignAddressItem_src_pointer_addr_from_buffer.restype = (
    ct.c_uint64
)
...
st_AssignAddressItem_are_equal = (
    sixtracklib.st_AssignAddressItem_are_equal_ext
)
...
st_AssignAddressItem_add_copy = (
    sixtracklib.st_AssignAddressItem_add_copy
)
...
def st_Particles_cbuffer_get_particles(cbuffer, obj_index):
    return ct.cast(
        cbuffer.get_object_address(obj_index), st_Particles_p
    )
...
st_Particles_buffer_get_total_num_of_particles.restype = (
    st_particle_num_elem_t
)
st_Particles_buffer_get_total_num_of_particles.argtypes = [
    st_Buffer_p
]
...
st_Particles_buffer_get_num_of_particle_blocks.restype = (
    st_buffer_size_t
)
st_Particles_buffer_get_num_of_particle_blocks.argtypes = [
    st_Buffer_p
]
...
st_Particles_buffer_get_particles.argtypes = [
    st_Buffer_p,
    st_buffer_size_t,
]
...
st_Particles_get_required_num_slots.argtypes = [
    st_Buffer_p,
    st_buffer_size_t,
]
...
st_ParticlesAddr_remap_addresses.argtypes = [
    st_ParticlesAddr_p,
    ct.c_int64,
]
...
st_Buffer_is_particles_buffer = (
    sixtracklib.st_Buffer_is_particles_buffer_ext
)
...
st_ELEM_BY_ELEM_ORDER_TURN_ELEM_PARTICLES = st_elem_by_elem_order_int_t(
    0
)
st_ELEM_BY_ELEM_ORDER_DEFAULT = (
...
st_ElemByElemConfig_get_num_particles_to_store.restype = (
    st_particle_num_elem_t
)
...
st_ElemByElemConfig_get_num_turns_to_store.argtypes = [
    st_ElemByElemConfig_p
]
st_ElemByElemConfig_get_num_turns_to_store.restype = (
    st_particle_num_elem_t
)
...
st_ElemByElemConfig_get_num_elements_to_store.restype = (
    st_particle_num_elem_t
)
...
st_ElemByElemConfig_get_min_particle_id.argtypes = [
    st_ElemByElemConfig_p
]
...
st_ElemByElemConfig_get_max_particle_id.argtypes = [
    st_ElemByElemConfig_p
]
...
st_ElemByElemConfig_get_min_element_id.argtypes = [
    st_ElemByElemConfig_p
]
...
st_ElemByElemConfig_get_max_element_id.argtypes = [
    st_ElemByElemConfig_p
]
...
st_ElemByElemConfig_is_rolling = (
    sixtracklib.st_ElemByElemConfig_is_rolling_ext
)
st_ElemByElemConfig_is_rolling.argtypes = [st_ElemByElemConfig_p]
st_ElemByElemConfig_is_rolling.restype = ct.c_bool

st_ElemByElemConfig_get_order = (
    sixtracklib.st_ElemByElemConfig_get_order_ext
)
...
st_ElemByElemConfig_get_particles_store_index.restype = (
    st_particle_num_elem_t
)
...
st_ElemByElemConfig_get_at_turn_from_store_index.restype = (
    st_particle_index_t
)
...
def st_ElemByElemConfig_assign_output_cbuffer(
    ...
    out_buffer_offset_index_arg = st_buffer_size_t(
...
st_ElemByElemConfig_preset = (
    sixtracklib.st_ElemByElemConfig_preset_ext
)
...
st_ElemByElemConfig_set_order = (
    sixtracklib.st_ElemByElemConfig_set_order_ext
)
...
def st_BeamMonitor_assign_output_cbuffer(
    ...
    ptr_belem_buffer = st_Buffer_new_mapped_on_cbuffer(
        beam_elements_buffer
    )
    ptr_output_buffer = st_Buffer_new_mapped_on_cbuffer(output_buffer)
...
st_OutputBuffer_required_for_tracking_of_particle_sets.restype = (
    ct.c_int32
)
...
def st_OutputBuffer_create_output_cbuffer(
    ...
    ptr_particles_buffer = st_Buffer_new_mapped_on_cbuffer(
        particles_buffer
    )
    particles = st_Particles_buffer_get_particles(
        ptr_particles_buffer, 0
    )
    ...
    if (
        ...
        ptr_out_buffer_view = st_Buffer_new_mapped_on_cbuffer(
            output_buffer
        )
...
st_TrackJobDestSrcBufferIds_p = ct.POINTER(
    st_TrackJobDestSrcBufferIds
)
st_NullTrackJobDestSrcBufferIds = ct.cast(
    0, st_TrackJobDestSrcBufferIds_p
)
...
st_TrackJob_reset_with_output = (
    sixtracklib.st_TrackJob_reset_with_output
)
...
st_TrackJob_track_elem_by_elem = (
    sixtracklib.st_TrackJob_track_elem_by_elem
)
...
st_TrackJob_collect_detailed = (
    sixtracklib.st_TrackJob_collect_detailed
)
st_TrackJob_collect_detailed.argtypes = [st_TrackJob_p, ct.c_uint16]
st_TrackJob_collect_detailed.restype = None

st_TrackJob_collect_particles = (
    sixtracklib.st_TrackJob_collect_particles
)
...
st_TrackJob_requires_collecting = (
    sixtracklib.st_TrackJob_requires_collecting
)
...
st_TrackJob_push_beam_elements = (
    sixtracklib.st_TrackJob_push_beam_elements
)
...
st_TrackJob_has_output_buffer = (
    sixtracklib.st_TrackJob_has_output_buffer
)
st_TrackJob_has_output_buffer.argtypes = [st_TrackJob_p]
st_TrackJob_has_output_buffer.restype = ct.c_bool


st_TrackJob_owns_output_buffer = (
    sixtracklib.st_TrackJob_owns_output_buffer
)
st_TrackJob_owns_output_buffer.argtypes = [st_TrackJob_p]
st_TrackJob_owns_output_buffer.restype = ct.c_bool


st_TrackJob_get_output_buffer = (
    sixtracklib.st_TrackJob_get_output_buffer
)
...
st_TrackJob_get_elem_by_elem_output_buffer_offset.argtypes = [
    st_TrackJob_p
]
st_TrackJob_get_elem_by_elem_output_buffer_offset.restype = (
    ct.c_uint64
)
...
st_TrackJob_get_beam_monitor_output_buffer_offset.argtypes = [
    st_TrackJob_p
]
st_TrackJob_get_beam_monitor_output_buffer_offset.restype = (
    ct.c_uint64
)
...
st_TrackJob_fetch_particles_addr = (
    sixtracklib.st_TrackJob_fetch_particles_addr
)
st_TrackJob_fetch_particles_addr.argtypes = [st_TrackJob_p]
st_TrackJob_fetch_particles_addr.restype = st_arch_status_t

st_TrackJob_clear_particles_addr = (
    sixtracklib.st_TrackJob_clear_particles_addr
)
st_TrackJob_clear_particles_addr.argtypes = [
    st_TrackJob_p,
    st_buffer_size_t,
]
...
st_TrackJob_particles_addr.argtypes = [
    st_TrackJob_p,
    st_buffer_size_t,
]
...
st_TrackJob_has_stored_buffers = (
    sixtracklib.st_TrackJob_has_stored_buffers
)
st_TrackJob_has_stored_buffers.argtypes = [st_TrackJob_p]
st_TrackJob_has_stored_buffers.restype = ct.c_bool

st_TrackJob_num_stored_buffers = (
    sixtracklib.st_TrackJob_num_stored_buffers
)
st_TrackJob_num_stored_buffers.argtypes = [st_TrackJob_p]
st_TrackJob_num_stored_buffers.restype = st_arch_size_t

st_TrackJob_min_stored_buffer_id = (
    sixtracklib.st_TrackJob_min_stored_buffer_id
)
st_TrackJob_min_stored_buffer_id.argtypes = [st_TrackJob_p]
st_TrackJob_min_stored_buffer_id.restype = st_arch_size_t

st_TrackJob_max_stored_buffer_id = (
    sixtracklib.st_TrackJob_max_stored_buffer_id
)
st_TrackJob_max_stored_buffer_id.argtypes = [st_TrackJob_p]
st_TrackJob_max_stored_buffer_id.restype = st_arch_size_t

st_TrackJob_create_stored_buffer = (
    sixtracklib.st_TrackJob_create_stored_buffer
)
st_TrackJob_create_stored_buffer.argtypes = [
    st_TrackJob_p,
    st_buffer_size_t,
]
st_TrackJob_create_stored_buffer.restype = st_arch_size_t

st_TrackJob_add_stored_buffer = (
    sixtracklib.st_TrackJob_add_stored_buffer
)
...
st_TrackJob_owns_stored_buffer = (
    sixtracklib.st_TrackJob_owns_stored_buffer
)
st_TrackJob_owns_stored_buffer.argtypes = [
    st_TrackJob_p,
    st_arch_size_t,
]
st_TrackJob_owns_stored_buffer.restype = ct.c_bool

st_TrackJob_remove_stored_buffer = (
    sixtracklib.st_TrackJob_remove_stored_buffer
)
st_TrackJob_remove_stored_buffer.argtypes = [
    st_TrackJob_p,
    st_arch_size_t,
]
...
st_TrackJob_const_stored_buffer = (
    sixtracklib.st_TrackJob_const_stored_buffer
)
st_TrackJob_const_stored_buffer.argtypes = [
    st_TrackJob_p,
    st_arch_size_t,
]
st_TrackJob_const_stored_buffer.restype = st_Buffer_p

st_TrackJob_push_stored_buffer = (
    sixtracklib.st_TrackJob_push_stored_buffer
)
st_TrackJob_push_stored_buffer.argtypes = [
    st_TrackJob_p,
    st_arch_size_t,
]
...
st_TrackJob_collect_stored_buffer.argtypes = [
    st_TrackJob_p,
    st_arch_size_t,
]
...
st_TrackJob_add_assign_address_item_detailed.restype = (
    st_AssignAddressItem_p
)
...
st_TrackJob_index_of_assign_address_item_detailed.restype = (
    st_buffer_size_t
)
...
st_TrackJob_has_assign_items = (
    sixtracklib.st_TrackJob_has_assign_items
)
...
st_TrackJob_num_assign_items = (
    sixtracklib.st_TrackJob_num_assign_items
)
...
st_TrackJob_ptr_assign_address_item_by_index.restype = (
    st_AssignAddressItem_p
)
...
st_TrackJob_ptr_assign_address_item_detailed.restype = (
    st_AssignAddressItem_p
)
...
st_TrackJob_buffer_by_buffer_id = (
    sixtracklib.st_TrackJob_buffer_by_buffer_id
)
st_TrackJob_buffer_by_buffer_id.argtypes = [
    st_TrackJob_p,
    st_buffer_size_t,
]
...
st_TrackJob_is_buffer_by_buffer_id.argtypes = [
    st_TrackJob_p,
    st_buffer_size_t,
]
...
st_NodeInfo_is_selected_node = (
    sixtracklib.st_NodeInfo_is_selected_node
)
...
st_NodeInfo_has_platform_name = (
    sixtracklib.st_NodeInfo_has_platform_name
)
...
st_NodeInfo_get_platform_name = (
    sixtracklib.st_NodeInfo_get_platform_name
)
...
st_KernelConfig_has_arch_string = (
    sixtracklib.st_KernelConfig_has_arch_string
)
...
_st_KernelConfig_get_ptr_arch_string.argtypes = [
    st_KernelConfigBase_p
]
_st_KernelConfig_get_ptr_arch_string.restype = ct.c_char_p

st_KernelConfig_has_kernel_id = (
    sixtracklib.st_KernelConfig_has_kernel_id
)
st_KernelConfig_has_kernel_id.argtypes = [st_KernelConfigBase_p]
st_KernelConfig_has_kernel_id.restype = ct.c_bool

st_KernelConfig_get_kernel_id = (
    sixtracklib.st_KernelConfig_get_kernel_id
)
...
_st_KernelConfig_get_ptr_name_string.argtypes = [
    st_KernelConfigBase_p
]
...
st_KernelConfig_get_total_num_work_items.argtypes = [
    st_KernelConfigBase_p
]
...
st_KernelConfig_get_work_group_size_by_dim.argtypes = [
    st_KernelConfigBase_p
]
...
st_KernelConfig_set_preferred_work_group_multiple_1d.restype = (
    st_ctrl_status_t
)
...
st_KernelConfig_set_preferred_work_group_multiple_2d.restype = (
    st_ctrl_status_t
)
...
st_KernelConfig_set_preferred_work_group_multiple_3d.restype = (
    st_ctrl_status_t
)
...
st_KernelConfig_set_preferred_work_group_multiple.restype = (
    st_ctrl_status_t
)
...
st_KernelConfig_needs_update = (
    sixtracklib.st_KernelConfig_needs_update
)
...
st_Controller_has_arch_string = (
    sixtracklib.st_Controller_has_arch_string
)
...
st_Controller_get_arch_string = (
    sixtracklib.st_Controller_get_arch_string
)
...
st_Controller_has_config_string = (
    sixtracklib.st_Controller_has_config_string
)
...
st_Controller_get_config_string = (
    sixtracklib.st_Controller_get_config_string
)
...
st_Controller_receive_detailed = (
    sixtracklib.st_Controller_receive_detailed
)
...
st_Controller_receive_buffer = (
    sixtracklib.st_Controller_receive_buffer
)
...
st_Controller_is_ready_to_remap = (
    sixtracklib.st_Controller_is_ready_to_remap
)
...
st_Controller_is_ready_to_send = (
    sixtracklib.st_Controller_is_ready_to_send
)
...
st_Controller_enable_debug_mode = (
    sixtracklib.st_Controller_enable_debug_mode
)
...
st_Controller_disable_debug_mode = (
    sixtracklib.st_Controller_disable_debug_mode
)
...
st_Controller_get_num_of_kernels = (
    sixtracklib.st_Controller_get_num_of_kernels
)
...
st_Controller_kernel_has_name = (
    sixtracklib.st_Controller_kernel_has_name
)
st_Controller_kernel_has_name.argtypes = [
    st_ControllerBase_p,
    st_kernel_id_t,
]
...
st_Controller_has_kernel_id.argtypes = [
    st_ControllerBase_p,
    st_kernel_id_t,
]
...
st_Controller_has_kernel_by_name = (
    sixtracklib.st_Controller_has_kernel_by_name
)
st_Controller_has_kernel_by_name.argtypes = [
    st_ControllerBase_p,
    ct.c_char_p,
]
...
st_Controller_get_ptr_kernel_config_base.restype = (
    st_KernelConfigBase_p
)
...
st_Controller_get_ptr_kernel_config_base_by_name.restype = (
    st_KernelConfigBase_p
)
...
st_Controller_has_remap_cobject_buffer_kernel.argtypes = [
    st_ControllerBase_p
]
...
st_Controller_get_remap_cobject_buffer_kernel_id.restype = (
    st_kernel_id_t
)
...
st_Controller_has_remap_cobject_buffer_debug_kernel.restype = (
    ct.c_bool
)
...
st_Controller_get_remap_cobject_buffer_debug_kernel_id.restype = (
    st_kernel_id_t
)
...
st_Controller_has_default_node = (
    sixtracklib.st_Controller_has_default_node
)
...
st_Controller_get_default_node_info_base.argtypes = [
    st_ControllerBase_p
]
...
st_Controller_is_default_node_id.argtypes = [
    st_ControllerBase_p,
    st_NodeId_p,
]
...
st_Controller_is_default_node = (
    sixtracklib.st_Controller_is_default_node
)
st_Controller_is_default_node.argtypes = [
    st_ControllerBase_p,
    ct.c_char_p,
]
...
st_Controller_is_node_available_by_platform_id_and_device_id.restype = (
    ct.c_bool
)
...
st_Controller_is_node_available.argtypes = [
    st_ControllerBase_p,
    ct.c_char_p,
]
...
st_Controller_get_min_available_node_index.argtypes = [
    st_ControllerBase_p
]
...
st_Controller_get_max_available_node_index.argtypes = [
    st_ControllerBase_p
]
...
st_Controller_get_node_index = (
    sixtracklib.st_Controller_get_node_index
)
st_Controller_get_node_index.argtypes = [
    st_ControllerBase_p,
    ct.c_char_p,
]
...
st_Controller_get_ptr_node_id_by_platform_id_and_device_id.restype = (
    st_NodeId_p
)

st_Controller_get_ptr_node_id = (
    sixtracklib.st_Controller_get_ptr_node_id
)
st_Controller_get_ptr_node_id.argtypes = [
    st_ControllerBase_p,
    ct.c_char_p,
]
...
st_Controller_get_ptr_node_info_base_by_index.restype = (
    st_NodeInfoBase_p
)
...
st_Controller_get_ptr_node_info_base_by_node_id.restype = (
    st_NodeInfoBase_p
)
...
st_Controller_has_selected_node = (
    sixtracklib.st_Controller_has_selected_node
)
...
st_Controller_get_ptr_selected_node_id.argtypes = [
    st_ControllerBase_p
]
...
st_Controller_get_ptr_selected_node_info_base.argtypes = [
    st_ControllerBase_p
]
st_Controller_get_ptr_selected_node_info_base.restype = (
    st_NodeInfoBase_p
)
...
st_Controller_get_selected_node_id_str.argtypes = [
    st_ControllerBase_p
]
...
st_Controller_select_node.argtypes = [
    st_ControllerBase_p,
    ct.c_char_p,
]
...
st_Controller_can_unselect_node = (
    sixtracklib.st_Controller_can_unselect_node
)
...
st_Argument_send_raw_argument = (
    sixtracklib.st_Argument_send_raw_argument
)
...
st_Argument_receive_raw_argument = (
    sixtracklib.st_Argument_receive_raw_argument
)
...
st_Argument_get_cobjects_buffer = (
    sixtracklib.st_Argument_get_cobjects_buffer
)
...
st_Argument_get_cobjects_buffer_slot_size.argtypes = [
    st_ArgumentBase_p
]
...
st_Argument_uses_raw_argument = (
    sixtracklib.st_Argument_uses_raw_argument
)
...
st_Argument_get_const_ptr_base_controller.argtypes = [
    st_ArgumentBase_p
]
st_Argument_get_const_ptr_base_controller.restype = (
    st_ControllerBase_p
)
...
st_TrackJobNew_new_with_output = (
    sixtracklib.st_TrackJobNew_new_with_output
)
...
st_TrackJobNew_track_until.argtypes = [
...
st_TrackJobNew_collect_detailed = (
    sixtracklib.st_TrackJobNew_collect_detailed
)
...
st_TrackJobNew_collect_particles = (
    sixtracklib.st_TrackJobNew_collect_particles
)
...
st_TrackJobNew_collect_output = (
    sixtracklib.st_TrackJobNew_collect_output
)
...
st_TrackJobNew_collect_particles_addresses.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_enable_collect_particles.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_disable_collect_particles.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_is_collecting_particles.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_enable_collect_beam_elements.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_disable_collect_beam_elements.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_is_collecting_beam_elements.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_disable_collect_output.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_get_collect_flags = (
    sixtracklib.st_TrackJobNew_get_collect_flags
)
...
st_TrackJobNew_set_collect_flags = (
    sixtracklib.st_TrackJobNew_set_collect_flags
)
...
st_TrackJobNew_push_particles = (
    sixtracklib.st_TrackJobNew_push_particles
)
...
st_TrackJobNew_can_fetch_particle_addresses.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_has_particle_addresses.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_fetch_particle_addresses.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_clear_all_particle_addresses.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_is_in_debug_mode = (
    sixtracklib.st_TrackJobNew_is_in_debug_mode
)
...
st_TrackJobNew_enable_debug_mode = (
    sixtracklib.st_TrackJobNew_enable_debug_mode
)
...
st_TrackJobNew_reset_with_output = (
    sixtracklib.st_TrackJobNew_reset_with_output
)
...
st_TrackJobNew_reset_detailed = (
    sixtracklib.st_TrackJobNew_reset_detailed
)
...
st_TrackJobNew_has_arch_string = (
    sixtracklib.st_TrackJobNew_has_arch_string
)
...
st_TrackJobNew_get_arch_string = (
    sixtracklib.st_TrackJobNew_get_arch_string
)
...
st_TrackJobNew_has_config_str = (
    sixtracklib.st_TrackJobNew_has_config_str
)
...
st_TrackJobNew_get_config_str = (
    sixtracklib.st_TrackJobNew_get_config_str
)
...
st_TrackJobNew_get_particle_set_indices_begin.argtypes = [
    st_TrackJobBaseNew_p
]
st_TrackJobNew_get_particle_set_indices_begin.restype = (
    st_buffer_size_p
)
...
st_TrackJobNew_get_particle_set_indices_end.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_get_total_num_of_particles.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_get_min_initial_turn_id.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_get_max_initial_turn_id.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_get_const_particles_buffer.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_get_beam_elements_buffer.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_get_const_beam_elements_buffer.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_has_output_buffer = (
    sixtracklib.st_TrackJobNew_has_output_buffer
)
...
st_TrackJobNew_has_elem_by_elem_output.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_has_beam_monitor_output.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_get_beam_monitor_output_buffer_offset.restype = (
    st_buffer_size_t
)
...
st_TrackJobNew_get_elem_by_elem_output_buffer_offset.restype = (
    st_buffer_size_t
)
...
st_TrackJobNew_get_num_elem_by_elem_turns.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_get_const_output_buffer.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_get_beam_monitor_indices_begin.argtypes = [
    st_TrackJobBaseNew_p
]
st_TrackJobNew_get_beam_monitor_indices_begin.restype = (
    st_buffer_size_p
)
...
st_TrackJobNew_get_beam_monitor_indices_end.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_has_elem_by_elem_config.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_get_elem_by_elem_config.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_is_elem_by_elem_config_rolling.argtypes = [
    st_TrackJobBaseNew_p
]
...
st_TrackJobNew_get_default_elem_by_elem_config_rolling_flag.restype = (
    ct.c_bool
)
...
st_TrackJobNew_set_default_elem_by_elem_config_rolling_flag.restype = (
    None
)
...
st_TrackJobNew_uses_controller = (
    sixtracklib.st_TrackJobNew_uses_controller
)
...
st_TrackJobNew_uses_arguments = (
    sixtracklib.st_TrackJobNew_uses_arguments
)
...
if SIXTRACKLIB_MODULES.get("cuda", False):
    ...
    st_CudaNodeInfo_new_detailed = (
        sixtracklib.st_CudaNodeInfo_new_detailed
    )
    ...
    st_CudaNodeInfo_get_cuda_device_index.argtypes = [
        st_CudaNodeInfo_p
    ]
    st_CudaNodeInfo_get_cuda_device_index.restype = (
        st_cuda_dev_index_t
    )
    ...
    st_CudaNodeInfo_get_warp_size = (
        sixtracklib.st_CudaNodeInfo_get_warp_size
    )
    ...
    st_CudaNodeInfo_get_compute_capability.argtypes = [
        st_CudaNodeInfo_p
    ]
    ...
    st_CudaNodeInfo_get_num_multiprocessors.argtypes = [
        st_CudaNodeInfo_p
    ]
    ...
    st_CudaNodeInfo_get_max_threads_per_block.argtypes = [
        st_CudaNodeInfo_p
    ]
    ...
    st_CudaNodeInfo_get_max_threads_per_multiprocessor.restype = (
        st_arch_size_t
    )
    ...
    st_Cuda_num_available_nodes = (
        sixtracklib.st_Cuda_num_available_nodes
    )
    ...
    st_Cuda_num_available_nodes_detailed.argtypes = [
        ct.c_char_p,
        ct.c_char_p,
    ]
    st_Cuda_num_available_nodes_detailed.restype = st_arch_size_t

    st_Cuda_get_available_nodes = (
        sixtracklib.st_Cuda_get_available_nodes
    )
    st_Cuda_get_available_nodes.argtypes = [
        st_NodeId_p,
        st_arch_size_t,
    ]
    ...
    st_Cuda_print_available_nodes = (
        sixtracklib.st_Cuda_print_available_nodes
    )
    ...
    st_Cuda_get_available_node_id_strs_detailed.restype = (
        st_arch_size_t
    )
    ...
    st_CudaController_new_from_node_index.restype = (
        st_CudaController_p
    )
    ...
    st_CudaController_new_from_cuda_device_index.restype = (
        st_CudaController_p
    )
    ...
    st_CudaController_get_ptr_node_info_by_index.restype = (
        st_CudaNodeInfo_p
    )
    ...
    st_CudaController_get_ptr_node_info_by_node_id.restype = (
        st_CudaNodeInfo_p
    )
    ...
    st_CudaController_get_ptr_kernel_config.restype = (
        st_CudaKernelConfig_p
    )
    ...
    st_CudaController_is_managed_cobject_buffer_remapped.restype = (
        ct.c_bool
    )
    ...
    st_CudaController_remap_managed_cobject_buffer.restype = (
        st_arch_status_t
    )
    ...
    st_CudaController_send_memory = (
        sixtracklib.st_CudaController_send_memory
    )
    ...
    st_CudaArgument_get_const_cuda_arg_buffer.argtypes = [
        st_CudaArgument_p
    ]
    st_CudaArgument_get_const_cuda_arg_buffer.restype = (
        st_CudaArgBuffer_p
    )
    ...
    _st_CudaTrackJob_get_available_node_ids_list.restype = (
        st_ctrl_size_t
    )
    ...
    st_CudaTrackJob_get_available_node_indices_list.restype = (
        st_ctrl_size_t
    )
    ...
    st_CudaTrackJob_new_detailed = (
        sixtracklib.st_CudaTrackJob_new_detailed
    )
    ...
    st_CudaTrackJob_has_controller = (
        sixtracklib.st_CudaTrackJob_has_controller
    )
    ...
    st_CudaTrackJob_get_ptr_const_controller.argtypes = [
        st_CudaTrackJob_p
    ]
    st_CudaTrackJob_get_ptr_const_controller.restype = (
        st_CudaController_p
    )
    ...
    st_CudaTrackJob_get_ptr_particles_arg.argtypes = [
        st_CudaTrackJob_p
    ]
    ...
    st_CudaTrackJob_get_ptr_const_particles_arg.argtypes = [
        st_CudaTrackJob_p
    ]
    st_CudaTrackJob_get_ptr_const_particles_arg.restype = (
        st_CudaArgument_p
    )
    ...
    st_CudaTrackJob_has_beam_elements_arg.argtypes = [
        st_CudaTrackJob_p
    ]
    ...
    st_CudaTrackJob_get_ptr_beam_elements_arg.argtypes = [
        st_CudaTrackJob_p
    ]
    st_CudaTrackJob_get_ptr_beam_elements_arg.restype = (
        st_CudaArgument_p
    )
    ...
    st_CudaTrackJob_get_ptr_const_beam_elements_arg.restype = (
        st_CudaArgument_p
    )
    ...
    st_CudaTrackJob_get_ptr_const_output_arg.argtypes = [
        st_CudaTrackJob_p
    ]
    st_CudaTrackJob_get_ptr_const_output_arg.restype = (
        st_CudaArgument_p
    )
    ...
    st_CudaTrackJob_get_ptr_elem_by_elem_config_arg.restype = (
        st_CudaArgument_p
    )
    ...
    st_CudaTrackJob_has_debug_register_arg.argtypes = [
        st_CudaTrackJob_p
    ]
    ...
    st_CudaTrackJob_get_ptr_debug_register_arg.argtypes = [
        st_CudaTrackJob_p
    ]
    st_CudaTrackJob_get_ptr_debug_register_arg.restype = (
        st_CudaArgument_p
    )
    ...
    st_CudaTrackJob_has_particles_addr_arg.argtypes = [
        st_CudaTrackJob_p
    ]
    ...
    st_CudaTrackJob_get_ptr_particles_addr_arg.argtypes = [
        st_CudaTrackJob_p
    ]
    st_CudaTrackJob_get_ptr_particles_addr_arg.restype = (
        st_CudaArgument_p
    )
...
if SIXTRACKLIB_MODULES.get("opencl", False):
    ...
    class st_ClNodeId(ct.Structure):
        _fields_ = [
            ("platform_id", ct.c_int64),
            ("device_id", ct.c_int64),
        ]
    ...
    st_ComputeNodeId_are_equal = (
        sixtracklib.st_ComputeNodeId_are_equal_ext
    )
    st_ComputeNodeId_are_equal.argtypes = [
        st_ClNodeId_p,
        st_ClNodeId_p,
    ]
    ...
    st_ComputeNodeId_to_string = (
        sixtracklib.st_ComputeNodeId_to_string
    )
    ...
    st_ComputeNodeId_from_string = (
        sixtracklib.st_ComputeNodeId_from_string
    )
    st_ComputeNodeId_from_string.argtypes = [
        st_ClNodeId_p,
        ct.c_char_p,
    ]
    ...
    st_ComputeNodeId_from_string_with_format.restype = (
        st_arch_status_t
    )
    ...
    st_ComputeNodeInfo_preset = (
        sixtracklib.st_ComputeNodeInfo_preset_ext
    )
    ...
    st_ComputeNodeInfo_print_out = (
        sixtracklib.st_ComputeNodeInfo_print_out
    )
    st_ComputeNodeInfo_print_out.argtypes = [
        st_ClNodeInfo_p,
        st_ClNodeId_p,
    ]
    ...
    st_ComputeNodeInfo_reserve = (
        sixtracklib.st_ComputeNodeInfo_reserve
    )
    ...
    st_ComputeNodeInfo_is_valid = (
        sixtracklib.st_ComputeNodeInfo_is_valid_ext
    )
    ...
    st_ComputeNodeInfo_get_id = (
        sixtracklib.st_ComputeNodeInfo_get_id_ext
    )
    ...
    st_ComputeNodeInfo_get_arch = (
        sixtracklib.st_ComputeNodeInfo_get_arch_ext
    )
    ...
    st_ComputeNodeInfo_get_name = (
        sixtracklib.st_ComputeNodeInfo_get_name_ext
    )
    ...
    st_OpenCL_get_num_all_nodes = (
        sixtracklib.st_OpenCL_get_num_all_nodes
    )
    ...
    st_OpenCL_get_all_nodes.argtypes = [
        st_ClNodeInfo_p,
        st_arch_size_t,
    ]
    ...
    st_OpenCL_num_available_nodes = (
        sixtracklib.st_OpenCL_num_available_nodes
    )
    ...
    st_OpenCL_get_available_nodes = (
        sixtracklib.st_OpenCL_get_available_nodes
    )
    st_OpenCL_get_available_nodes.argtypes = [
        st_ClNodeId_p,
        st_arch_size_t,
    ]
    ...
    st_ClArgument_new_from_buffer = (
        sixtracklib.st_ClArgument_new_from_buffer
    )
    st_ClArgument_new_from_buffer.argtypes = [
        st_Buffer_p,
        st_ClContextBase_p,
    ]
    st_ClArgument_new_from_buffer.restype = st_ClArgument_p

    st_ClArgument_new_from_size = (
        sixtracklib.st_ClArgument_new_from_size
    )
    st_ClArgument_new_from_size.argtypes = [
        st_arch_size_t,
        st_ClContextBase_p,
    ]
    st_ClArgument_new_from_size.restype = st_ClArgument_p

    st_ClArgument_new_from_memory = (
        sixtracklib.st_ClArgument_new_from_memory
    )
    ...
    st_ClArgument_write_memory = (
        sixtracklib.st_ClArgument_write_memory
    )
    ...
    st_ClArgument_update_region = (
        sixtracklib.st_ClArgument_update_region
    )
    ...
    st_ClArgument_update_regions = (
        sixtracklib.st_ClArgument_update_regions
    )
    ...
    st_ClArgument_uses_cobj_buffer = (
        sixtracklib.st_ClArgument_uses_cobj_buffer
    )
    ...
    st_ClContextBase_default_compile_options.argtypes = [
        st_ClContextBase_p
    ]
    ...
    st_ClContextBase_new_on_selected_node_id_str.argtypes = [
        ct.c_char_p
    ]
    st_ClContextBase_new_on_selected_node_id_str.restype = (
        st_ClContextBase_p
    )
    ...
    st_ClContextBase_new_on_selected_node_id.argtypes = [
        st_ClNodeId_p
    ]
    st_ClContextBase_new_on_selected_node_id.restype = (
        st_ClContextBase_p
    )
    ...
    st_ClContextBase_reinit_default_programs.argtypes = [
        st_ClContextBase_p
    ]
    st_ClContextBase_reinit_default_programs.restype = (
        st_arch_status_t
    )
    ...
    st_ClContextBase_get_num_available_nodes.argtypes = [
        st_ClContextBase_p
    ]
    ...
    st_ClContextBase_get_available_node_info_by_index.restype = (
        st_ClNodeInfo_p
    )
    ...
    st_ClContextBase_is_available_node_amd_platform.restype = (
        ct.c_bool
    )
    ...
    st_ClContextBase_get_default_node_info.argtypes = [
        st_ClContextBase_p
    ]
    ...
    st_ClContextBase_get_default_node_id.argtypes = [
        st_ClContextBase_p
    ]
    ...
    st_ClContextBase_is_node_id_available.argtypes = [
        st_ClContextBase_p
    ]
    ...
    st_ClContextBase_is_platform_device_tuple_available.restype = (
        ct.c_bool
    )
    ...
    st_ClContextBase_is_platform_device_tuple_default_node.restype = (
        ct.c_bool
    )
    ...
    st_ClContextBase_get_selected_node_info.argtypes = [
        st_ClContextBase_p
    ]
    ...
    st_ClContextBase_get_selected_node_id.argtypes = [
        st_ClContextBase_p
    ]
    ...
    st_ClContextBase_get_selected_node_index.argtypes = [
        st_ClContextBase_p
    ]
    ...
    st_OpenCL_get_all_nodes_required_str_capacity.restype = (
        st_arch_size_t
    )
    ...
    st_OpenCL_get_all_nodes_as_string.argtypes = [
        ct.c_char_p,
        st_arch_size_t,
    ]
    ...
    st_OpenCL_get_available_nodes_required_str_capacity.restype = (
        st_arch_size_t
    )
    ...
    st_ClContextBase_select_node = (
        sixtracklib.st_ClContextBase_select_node
    )
    st_ClContextBase_select_node.argtypes = [
        st_ClContextBase_p,
        ct.c_char_p,
    ]
    ...
    st_ClContextBase_get_num_available_programs.argtypes = [
        st_ClContextBase_p
    ]
    st_ClContextBase_get_num_available_programs.restype = (
        st_arch_size_t
    )
    ...
    st_ClContextBase_get_required_program_path_capacity.restype = (
        st_arch_size_t
    )
    ...
    st_ClContextBase_get_num_available_kernels.argtypes = [
        st_ClContextBase_p
    ]
    st_ClContextBase_get_num_available_kernels.restype = (
        st_arch_size_t
    )
    ...
    st_ClContextBase_find_kernel_id_by_name.restype = (
        st_arch_kernel_id_t
    )
    ...
    st_ClContextBase_get_kernel_local_mem_size.restype = (
        st_arch_size_t
    )
    ...
    st_ClContextBase_get_kernel_max_work_group_size.restype = (
        st_arch_size_t
    )
    ...
    st_ClContextBase_get_kernel_argument_type.restype = (
        st_kernel_arg_type_t
    )
    ...
    st_ClContextBase_calculate_kernel_num_work_items.restype = (
        st_arch_size_t
    )

    st_ClContextBase_run_kernel = (
        sixtracklib.st_ClContextBase_run_kernel
    )
    ...
    st_ClContextBase_get_last_exec_work_group_size.restype = (
        st_arch_size_t
    )
    ...
    st_ClContextBase_get_last_exec_num_work_items.restype = (
        st_arch_size_t
    )
    ...
    st_ClContextBase_get_program_id_by_kernel_id.restype = (
        st_arch_program_id_t
    )
    ...
    st_ClContextBase_has_remapping_program.argtypes = [
        st_ClContextBase_p
    ]
    ...
    st_ClContextBase_remapping_program_id.argtypes = [
        st_ClContextBase_p
    ]
    st_ClContextBase_remapping_program_id.restype = (
        st_arch_program_id_t
    )
    ...
    st_ClContextBase_has_remapping_kernel.argtypes = [
        st_ClContextBase_p
    ]
    ...
    st_ClContextBase_remapping_kernel_id.argtypes = [
        st_ClContextBase_p
    ]
    ...
    st_ClContextBase_set_remapping_kernel_id.restype = (
        st_arch_status_t
    )
    ...
    st_ClContextBase_is_debug_mode_enabled.argtypes = [
        st_ClContextBase_p
    ]
    ...
    st_ClContextBase_disable_debug_mode.argtypes = [
        st_ClContextBase_p
    ]
    ...
    st_ClContextBase_feature_flag.argtypes = [
        st_ClContextBase_p,
        ct.c_char_p,
    ]
    ...
    st_ClContextBase_feature_flag_repr_as_cstr.restype = (
        st_arch_status_t
    )
    ...
    st_ClContext_track_until_for_particle_set.restype = (
        st_track_status_t
    )
    ...
    st_ClContext_track_line_for_particle_set.restype = (
        st_track_status_t
    )
    ...
    st_ClContext_has_track_elem_by_elem_kernel.argtypes = [
        st_ClContext_p
    ]
    ...
    st_ClContext_track_elem_by_elem_kernel_id.argtypes = [
        st_ClContext_p
    ]
    st_ClContext_track_elem_by_elem_kernel_id.restype = (
        st_arch_kernel_id_t
    )
    ...
    st_ClContext_set_track_elem_by_elem_kernel_id.restype = (
        st_arch_status_t
    )
    ...
    st_ClContext_track_elem_by_elem_for_particle_set.restype = (
        st_track_status_t
    )
    ...
    st_ClContext_has_assign_beam_monitor_output_kernel.restype = (
        ct.c_bool
    )
    ...
    st_ClContext_has_assign_elem_by_elem_output_kernel.restype = (
        ct.c_bool
    )
    ...
    st_ClContext_assign_elem_by_elem_output_kernel_id.restype = (
        ct.c_bool
    )
    ...
    st_ClContext_has_clear_beam_monitor_output_kernel.restype = (
        ct.c_bool
    )
    ...
    st_ClContext_has_assign_addresses_kernel.argtypes = [
        st_ClContext_p
    ]
    ...
    st_ClContext_assign_addresses_kernel_id.argtypes = [
        st_ClContext_p
    ]
    st_ClContext_assign_addresses_kernel_id.restype = (
        st_arch_kernel_id_t
    )
    ...
    st_ClContext_set_assign_addresses_kernel_id.restype = (
        st_arch_status_t
    )

    st_ClContext_assign_addresses = (
        sixtracklib.st_ClContext_assign_addresses
    )
    ...
    st_ClContext_num_particles_in_selected_set.argtypes = [
        st_ClContext_p
    ]
    st_ClContext_num_particles_in_selected_set.restype = (
        st_buffer_size_t
    )
    ...
    st_ClContext_disable_optimized_tracking.argtypes = [
        st_ClContext_p
    ]
    ...
    st_ClContext_is_beam_beam_tracking_enabled.argtypes = [
        st_ClContext_p
    ]
    ...
    st_ClContext_disable_beam_beam_tracking.argtypes = [
        st_ClContext_p
    ]
    ...
    st_TrackJobCl_const_argument_by_buffer_id.restype = (
        st_ClArgument_p
    )
    ...
    st_TrackJobCl_const_stored_buffer_argument.restype = (
        st_ClArgument_p
    )
...
st_Track_all_particles_element_by_element_until_turn.restype = (
    st_track_status_t
)
