...
from .stcommon import st_TrackJobBaseNew_p, st_NullTrackJobBaseNew, \
    ...
    st_track_job_size_t, st_TrackJobNew_delete, st_TrackJobNew_track_until, \
    st_buffer_size_t, \
...
class TrackJobBaseNew(object):
    def __init__(self, ptr_track_job=None, owns_ptr=True, output_buffer=None,
                 particles_buffer=buffer, beam_elements_buffer=None ):
    ...
    def track_until(self, until_turn):
        return st_TrackJobNew_track_until(
            self._ptr_track_job, st_buffer_size_t( until_turn ) )

    def track_elem_by_elem(self, until_turn):
        return st_TrackJobNew_track_elem_by_elem(
            self._ptr_track_job, st_buffer_size_t( until_turn ) )

    def track_line(self, be_begin_idx, be_end_idx, finish_turn=False):
        return st_TrackJobNew_track_line( self._ptr_track_job,
            st_buffer_size_t( be_begin_idx ), st_buffer_size_t( be_end_idx ),
